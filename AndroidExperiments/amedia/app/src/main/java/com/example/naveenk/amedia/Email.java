...
public class Email extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        convertEditTextVarsIntoStringsAndYesThisIsAMathodWeCreated();
        ...
        String message = "Well Hello "
                ...
                + out
                +". Oh also if you get bored you should check out www.example.com"
    ...
    private void convertEditTextVarsIntoStringsAndYesThisIsAMathodWeCreated() {
